...
// ldr #include <AP_HAL_AVR_SITL.h>
// ldr #include <AP_HAL_PX4.h>
// ldr #include <AP_HAL_VRBRAIN.h>
// ldr #include <AP_HAL_FLYMAPLE.h>
#include <AP_HAL_Linux.h>
// ldr #include <AP_HAL_Empty.h>

// Application dependencies
#include <GCS.h>
#include <GCS_MAVLink.h>        // MAVLink GCS definitions
#include <AP_GPS.h>             // ArduPilot GPS library
// ldr #include <AP_GPS_Glitch.h>      // GPS glitch protection library
#include <DataFlash.h>          // ArduPilot Mega Flash Memory Library
#include <AP_ADC.h>             // ArduPilot Mega Analog to Digital Converter Library
#include <AP_ADC_AnalogSource.h>
#include <AP_Baro.h>
// ldr #include <AP_Baro_Glitch.h>     // Baro glitch protection library
...
void setup()
{
    //ldr cliSerial = hal.console; нахер консоль

    // Load the default values of variables listed in var_info[]s
    // ldr AP_Param::setup_sketch_defaults(); с переменными разбираться по мере их использования

    // setup storage layout for copter
    //ldr StorageManager::set_layout_copter(); тоже какая то фигня для хранения

    init_ardupilot();

    // initialise the main loop scheduler
//ldr    scheduler.init(&scheduler_tasks[0], sizeof(scheduler_tasks)/sizeof(scheduler_tasks[0]));
}
