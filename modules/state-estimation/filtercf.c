...
static int32_t complementaryFilter(data_t *this, float gyro[3], float accel[3], float mag[3], float attitude[4]);
...
static int32_t maininit(stateFilter *self)
{
    ...
    // self->module->params_state_estimation.AccelLowPassKp
