...
Main project front-end:    http://www.linuxdrone.org/
Project forums:            http://forum.linuxdrone.org/
Wiki, docs and manuals:    http://wiki.linuxdrone.org/
Bug and issue tracker:     http://jira.linuxdrone.org/
Project build server:      http://bamboo.linuxdrone.org/
Repository browser:        http://code.linuxdrone.org/
Read-only github mirror:   https://github.com/osnwt/LinuxDrone
Read/write source access: ssh://git@git.linuxdrone.org
Auto toolchain downloads:  http://downloads.linuxdrone.org
