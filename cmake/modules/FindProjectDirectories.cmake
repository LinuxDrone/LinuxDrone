...
if(DEFINED ENV{LINUXDRONE_ROOTFS_DIR})
    file(TO_CMAKE_PATH "$ENV{LINUXDRONE_ROOTFS_DIR}" ROOTFS_DIR)
    message(STATUS "User-defined rootfs directory: ${ROOTFS_DIR}")
else()
    set(ROOTFS_DIR ${TOOLS_DIR}/rootfs)
    message(STATUS "Automatically set rootfs directory: ${ROOTFS_DIR}")
endif()
